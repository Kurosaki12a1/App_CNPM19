                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                          ...
                          //  @SuppressWarnings("VisibleForTests")
                            ImageUploadInfo imageUploadInfo = new ImageUploadInfo(taskSnapshot.getDownloadUrl().toString(),0,txtCaption,userId );
                            ...
                            PostInfo postInfo=new PostInfo(postID,userId,"0",txtCaption);
                ...
                storageReference2nd.putFile(LFilePathUri.get(i))
                        .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                ...
                                PostInfo postInfo = new PostInfo(postID, userId, "0", Caption.getText().toString());
                                databaseReference2nd.child(postID).setValue(postInfo);
                                databaseReference3rd.child(postID).child(ImageUploadId).setValue(imageUploadInfo);
